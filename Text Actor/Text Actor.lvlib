...
<Library LVVersion="20008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="Save text file Msg.lvclass" Type="LVClass" URL="../Text Actor Messages/Save text file Msg/Save text file Msg.lvclass"/>
		<Item Name="Write Path Msg.lvclass" Type="LVClass" URL="../Text Actor Messages/Write Path Msg/Write Path Msg.lvclass"/>
	</Item>
	<Item Name="Text Actor.lvclass" Type="LVClass" URL="../Text Actor/Text Actor.lvclass"/>
</Library>
